...
import com.hongsou.insist.tangfengguyun.base.BaseApplication;
...
public class TTSUtils implements InitListener, SynthesizerListener {
    ...
    public void init(Context context) {
        mContext = context;
        mTts = SpeechSynthesizer.createSynthesizer(BaseApplication.getAppContext(), this);
        // 清空参数
    ...
    public void onCompleted(SpeechError speechError) {
        if (speechError == null) {
            ((InfoActivity) mContext).setVisible();
